...
class BusinessCaseRequest(BaseModel):
    ...
    requirements: Dict[str, Any] = Field(
        default_factory=dict, description="Business requirements"
    )
...
class BusinessCase(BaseModel):
    ...
    generated_content: Dict[str, Any] = Field(
        default_factory=dict, description="Generated business case content"
    )
    ...
    generated_by_agents: List[str] = Field(
        default_factory=list, description="List of agents that contributed"
    )
...
class Job(BaseModel):
    ...
    business_case_id: Optional[str] = Field(
        None, description="Associated business case ID"
    )
