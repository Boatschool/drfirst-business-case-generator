    ...
    def _initialize_firebase(self):
        ...
        try:
            if not self._initialized and not firebase_admin._apps:
                ...
                print(f"✅ Firebase Admin SDK initialized successfully for project: {settings.firebase_project_id}")
            ...
            print(f"  - GOOGLE_APPLICATION_CREDENTIALS env: {os.getenv('GOOGLE_APPLICATION_CREDENTIALS')}")
