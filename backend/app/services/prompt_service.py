...
from ..models.agent_prompt import AgentPrompt, AgentPromptVersion, AgentPromptCreate, AgentPromptVersionCreate, AgentPromptUpdate
...
class PromptService:
    ...
    async def get_prompt_by_agent_function(self, agent_name: str, agent_function: str) -> Optional[AgentPrompt]:
    ...
    async def get_active_prompt_template(self, agent_name: str, agent_function: str) -> Optional[str]:
    ...
    async def render_prompt(self, agent_name: str, agent_function: str, variables: Dict[str, Any]) -> Optional[str]:
    ...
    async def add_prompt_version(self, prompt_id: str, version_data: AgentPromptVersionCreate, user_id: str) -> bool:
    ...
    async def update_prompt(self, prompt_id: str, update_data: AgentPromptUpdate, user_id: str) -> bool:
