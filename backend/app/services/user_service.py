...
class UserService:
    ...
    async def create_or_update_user(
        ...
        try:
            ...
            if doc.exists:
                ...
                print(f"✅ UserService: Created new user {email} with role {user_data['systemRole']}")
                return user_data
    ...
    async def sync_user_claims(self, uid: str) -> bool:
        ...
        try:
            ...
            print(f"✅ UserService: Synced claims for user {uid} with role {system_role}")
            return True
    ...
    async def check_and_sync_user_claims(self, decoded_token: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            if firestore_role != token_role:
                print(f"🔄 UserService: Role mismatch for {email} - Firestore: {firestore_role}, Token: {token_role}")
                ...
                print(f"ℹ️ UserService: Claims updated for {email}. User needs to refresh token for changes to take effect.")
