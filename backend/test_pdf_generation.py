...
async def test_pdf_generation():
    ...
    try:
        ...
        mock_case_data = {
            ...
            "relevant_links": [
                {
                    "name": "DrFirst Business Case Generator PRD",
                    "url": "https://drfirst.example.com/prd",
                },
                {
                    "name": "System Architecture Documentation",
                    "url": "https://confluence.drfirst.com/arch",
                },
                {
                    "name": "Project Jira Epic",
                    "url": "https://jira.drfirst.com/epic/BCG-001",
                },
            ],
...
- **Backend**: FastAPI with async/await patterns
        ...
        if pdf_bytes and len(pdf_bytes) > 0:
            ...
            for check_name, found in content_checks:
                ...
                print(
                    f"      {status} {check_name}: {'Found' if found else 'Not found'}"
                )
