    ...
    return (
      <div className="auth-test">
        <div className="sign-in">
          ...
          <p className="note">
            <strong>Note:</strong> Only @drfirst.com email addresses are
            allowed.
          </p>
        </div>
      </div>
    ...
    <div className="auth-test">
      <div className="user-info">
        ...
        <div className="user-details">
          ...
          <p>
            <strong>DrFirst User:</strong> {isDrFirstUser ? '✅ Yes' : '❌ No'}
          </p>
          <p>
            <strong>Valid Access:</strong> {isValidUser ? '✅ Yes' : '❌ No'}
          </p>
        </div>
        ...
        {!isValidUser && (
          <div className="warning">
            <p>
              ⚠️ Your account doesn't have valid access. Please contact an
              administrator.
            </p>
          </div>
        )}
