            ...
            <Grid item xs={12} md={3}>
              <Card variant="outlined" sx={{ textAlign: 'center', p: 2 }}>
                <Typography variant="h4" color="success.main" fontWeight="bold">
                  {formatPercentage(financial_summary_v1.financial_metrics?.primary_roi_percentage || 0)}
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Base ROI
                </Typography>
            ...
            <Grid item xs={12} md={3}>
              <Card variant="outlined" sx={{ textAlign: 'center', p: 2 }}>
                <Typography variant="h4" color="primary.main" fontWeight="bold">
                  {(financial_summary_v1.financial_metrics?.simple_payback_period_years || 0).toFixed(1)} years
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Payback Period
                </Typography>
      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="caption" display="block" sx={{ mt: 2, fontStyle: 'italic' }}>
            Generated by: {financial_summary_v1.generated_by} • 
            Calculation Date: {new Date(financial_summary_v1.calculated_at).toLocaleDateString()}
          </Typography>
        </CardContent>
      </Card>
    </Box>
