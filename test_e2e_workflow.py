...
async def test_complete_workflow():
    ...
    try:
        ...
        test_case_data = {
            ...
            "relevantLinks": [
                {"name": "Current System Analysis", "url": "https://example.com/current-analysis"},
                {"name": "Industry Best Practices", "url": "https://example.com/best-practices"}
            ]
        }
        ...
        if system_design:
            ...
            if len(design_content) > 0:
                ...
                print("─" * 60)
                print(design_content[:300] + "..." if len(design_content) > 300 else design_content)
                print("─" * 60)
...
async def test_api_response_format():
    ...
    try:
        ...
        try:
            ...
            print(f"   - Model includes system_design_v1_draft: {hasattr(model_instance, 'system_design_v1_draft')}")
            print(f"   - System design content available: {bool(model_instance.system_design_v1_draft)}")
            return True
...
async def main():
    ...
    if all_tests_passed:
        ...
        print(f"   ✅ Status transitions (INTAKE → PRD_DRAFTING → PRD_APPROVED → SYSTEM_DESIGN_DRAFTED)")
